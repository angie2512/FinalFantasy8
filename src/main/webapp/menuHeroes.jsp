        ...
        <div class="row">
            ...
            <div class="col-lg-7" style="text-align: center">
                <div class="col-lg-2" style="padding-top: 5vh; margin: 0px auto;">
                    <fieldset>
                        ...
                        <a type="button" class="btn btn-primary" href="<%=request.getContextPath()%>/HeroesServlet?accion=add" style="margin-left: 300px;width: 126px; background-color: #7453fc; border-color: #7453fc">
            ...
            <table class="table table-dark table-hover">
                ...
                <tr>
                    ...
                    <th scope="col" class="text-center">1°Inventario Obj</th>
                </tr>
                </thead>
                <tbody>
                <% int i = 1;
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a type="button" class="btn btn-danger", style="background-color: #7453fc; border-color: #7453fc"
                           href="<%=request.getContextPath()%>/HeroesServlet?=accion=listarinventario&id=<%= heroes.getIdHeroes()%>">
