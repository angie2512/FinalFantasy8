...
<%@ page import="com.example.finalfantasy.Bean.Clase" %>
<%@ page import="com.example.finalfantasy.Bean.ElementoClase" %>
<html>

<%
    ArrayList<Clase> listaclases = (ArrayList<Clase>) request.getAttribute("listaClases");
    ArrayList<ElementoClase> listafort = (ArrayList<ElementoClase>) request.getAttribute("forta");
    String nombredeclase = (String) request.getAttribute("clase");
%>
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="section-heading">
                    ...
                    <h2>Fortalezas y Debilidades de<em> <%=nombredeclase%> </em></h2>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <table class="table table-dark table-hover">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="text-center">Porcentaje Daño</th>
                        <th scope="col" class="text-center">Fort / Deb</th>
                        <th scope="col" class="text-center">Editar Daño</th>
                    </tr>
                    </thead>
                    <tbody>
                    <% for(ElementoClase ele : listafort) {%>
                    <tr>
                        <th class="text-center" scope="row"><%= ele.getElemento()%></th>
                        <td class="text-center"><%= ele.getDaño()*100+"%"%></td>
